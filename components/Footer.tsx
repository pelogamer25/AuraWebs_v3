        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1">
             ...
             <div className="flex space-x-4 mb-6">
                <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-aura-purple hover:text-white text-gray-400 transition-all"><Twitter size={18} /></a>
                <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-aura-purple hover:text-white text-gray-400 transition-all"><Linkedin size={18} /></a>
                <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-aura-purple hover:text-white text-gray-400 transition-all"><Instagram size={18} /></a>
                <a href="#" className="p-2 rounded-full bg-white/5 hover:bg-aura-purple hover:text-white text-gray-400 transition-all"><Github size={18} /></a>
             </div>
             <p className="text-sm text-gray-500">
               hello@aurawebs.site<br/>
               +1 (555) 123-4567
             </p>
          </div>
        </div>
