            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">aurawebsdev@gmail.com</p>
              ...
              >
                 <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-aura-magenta/20 transition-colors">
                  <Phone className="text-aura-magenta" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-aura-magenta transition-colors">WhatsApp Us</h3>
                  <p className="text-gray-400 group-hover:text-white transition-colors">+57 321 7466755</p>
